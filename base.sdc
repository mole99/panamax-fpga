...
# reset - synchronized
set_false_path -from [get_ports resetb_xres_n]

# fpga_sclk - synchronized
set_false_path -from [get_ports gpio8_1_in]

# fpga_cs_n - synchronized
set_false_path -from [get_ports gpio8_2_in]

# fpga_mosi - synchronized
set_false_path -from [get_ports gpio8_3_in]

# fpga_miso - synchronized
#set_false_path -from [get_ports gpio8_4_in]

# fpga_mode_i - static configuration
set_false_path -from [get_ports gpio8_5_in]
